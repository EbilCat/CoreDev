...
//*====================
        private void OnIsInspectedChanged(ObservableVar<bool> oIsInspected)
        {
            if (oIsInspected.Value)
            {
                ...
                this.observableVarInfoDO.RegisterForValueChanges(observableVarInstance, StartValueChangedPulse, false);
                this.observableVarInfoDO.RegisterForModeratorsChanges(observableVarInstance, StartModeratorsChangedPulse, false);
            }
            else
            {
                this.observableVarInfoDO?.UnregisterFromValueChangeBlocks(observableVarInstance, StartValueChangeBlockedPulse);
